...
import { getEventDefinition } from '../utils/EventDefinitionUtil';
...
function getScriptFormat(element) {
    const conditionExpression = getConditionExpression(element);

    if (conditionExpression) {
        return conditionExpression.get('language');
    } else {
        return undefined;
    }
}
